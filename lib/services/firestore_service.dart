...
CollectionReference tblData = FirebaseFirestore.instance.collection("data_jam");

class FireStoreService {
  //modul
  final CollectionReference users =
      FirebaseFirestore.instance.collection('users');
  // final CollectionReference datadeskripsi =
  //     FirebaseFirestore.instance.collection('data_jam');
  ...
  Stream<QuerySnapshot> getJam() {
    final jamStream = tblData.snapshots();
    return jamStream;
  }
